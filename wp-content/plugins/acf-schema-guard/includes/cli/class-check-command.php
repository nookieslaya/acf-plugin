...
final class CheckCommand {
	...
	private function table($findings) { if(empty($findings)){\WP_CLI::success('No schema changes found.');return;} $formatter=new FindingOutputFormatter(); \WP_CLI\Utils\format_items('table',$formatter->table_items($findings),$formatter->table_fields()); }
