...
$legacy_trashed = array( 'field_groups' => array( array( 'key' => 'group_legacy__trashed', 'title' => 'Discarded', 'active' => false ) ) );
if ( array() !== $differ->compare( $legacy_trashed, array( 'field_groups' => array() ) )->to_array()['changes'] ) { exit( 1 ); }
